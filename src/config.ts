...
// https://rpc.evaa.finance/api/v2/jsonRPC
export const rpcEndpoint = 'https://toncenter.com/api/v2/jsonRPC'
export const tonApiEndpoint = 'https://tonapi.io/'

export const serviceChatID = 391148065
// old: EQDo27P-CAam_G2xmQd4CxnFYjY2FKPmmKEc8wTCh4c33Mhi
export const highloadAddress = 'UQDY3g19Kvfdy1bdYXuCdJVzkeTxH_8A4v07kmIWmaM1nLHW'

export const HIGHLOAD_CODE = Cell.fromBase64(
