...
export function formatLiquidationSuccess(
    task: Task,
    assetsInfo: LiquidationAssetsInfo,
    loanAmount: bigint,
    ...
    const { loanAssetName, loanAssetDecimals, collateralAssetName, collateralAssetDecimals } = assetsInfo
...
export function formatLiquidationUnsatisfied(
    task: Task,
    transferedAssetName: string,
    transferedAssetDecimals: bigint,
...
export function formatSwapAssignedMessage(loanAssetName: string, collateralAssetName: string, collateralRewardAmount: bigint, collateralAssetDecimals: bigint) {
    return `<b>Assigned swap task</b> for exchanging of ${getFriendlyAmount(
